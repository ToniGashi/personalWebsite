...
import ProfilePicture from '@/public/pic.png';
...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] scroll-mt-[100rem] bg-transparent text-center sm:mb-0"
    >
      <div className="flex items-center justify-center">
        <div className="relative bg-transparent">
          ...
          <motion.span
            className="absolute bottom-0 right-0 bg-transparent text-4xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: 'spring',
      ...
      <motion.h1
        className="mb-10 mt-4 bg-transparent px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">Hello, I'm Toni.</span> I'm a{' '}
      ...
      <motion.div
        className="flex flex-col items-center justify-center gap-2 bg-transparent px-4 text-lg font-medium sm:flex-row"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
